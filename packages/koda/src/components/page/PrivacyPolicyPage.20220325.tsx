...
const PrivacyPolicyPage2022 = (props: Props) => {
  return (
    <React.Fragment>
  ...
  ⑤ 회사는 이용자 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.`}</Description>
          ...
          <Section>
            ...
            <Description>{`• 필수항목 : 이메일, 휴대전화번호, 주소, 생년월일, 이름, 국적, 직책, 회사명, 주주 정보, 서비스 이용 기록, 접속 로그, 접속 IP 정보`}</Description>
...
export default PrivacyPolicyPage2022;

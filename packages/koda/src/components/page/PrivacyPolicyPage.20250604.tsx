...
const PrivacyPolicyPage20250604 = () => {
  return (
    <React.Fragment>
...
가. 쿠키의 사용 목적 및 종류: 
   • 일반 쿠키: 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.
   • Typeform 쿠키: 사용자의 서비스 이용 패턴과 선호도를 분석하여 맞춤형 서비스 제공 및 사용자 경험 개선을 위해 사용됩니다.
...
export default PrivacyPolicyPage20250604;

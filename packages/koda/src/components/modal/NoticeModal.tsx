...
• 당사 수탁을 위한 입금 시, <b>당사에서 발행해 드린 고객용 입금주소를 확인하고, 정확하게 입력</b>해주시기 바랍니다. 
   ...
   <b>ㅇ 지원 네트워크 : 비트코인, 이더리움, 솔라나, 폴리곤, 바이낸스 스마트 체인, 아비트럼 원, 베이스, 카이아, 엑스플라, 
                                     오버, 스토리, 코어, 비즈오토 등</b>
• 고액 가상자산 <b>입출금 시 최소 수량(ex. 0.001BTC, 0.01ETH 등) 사전 입출금을 통해 검증 후,</b> 입출금 처리를 권장합니다.

  <b>◈ 입금 시</b> : 입금주소, 메인넷 확인 ➙ 최소수량 입금 ➙ 입금 확인(고객사 대시보드, 당사 문의) ➙ 잔액 입금 진행
  <b>◈ 출금 시</b>: 고객사 출금주소 등록 ➙ 당사에서 정당주소 여부 체크 ➙ 최소 수량 출금 ➙ 출금확인(고객 확인, 당사 문의) ➙ 
                       잔액 출금 진행

• <b>블록체인 주소 형식이 동일</b>해도 출금하는 가상자산의 블록체인 네트워크와 입금 받은 가상자산 주소의 <b>블록체인 
  네트워크가 다른 경우 오입금이 발생</b>합니다.(ex, 이더리움 기반의 USDT 및 솔라나 기반의 USDT)
• 출금 신청 완료 이후의 송금 과정은 <b>블록체인 네트워크에서 처리되며 네트워크 상태에 따라 출금시간이 지연</b>될 수 있습니다. 
• <b>부정거래가 의심될 경우 출금이 제한</b>될 수 있습니다.
• 고객확인 <b>미등록 계정은 가상자산 출금이 불가</b>합니다.
• <b>오입금 우려되시는 경우 등, 가상자산 입출금 관련 궁금한 사항은 당사에 문의</b>를 하신 후에 입출금을 진행하여 주시기 
  바랍니다.

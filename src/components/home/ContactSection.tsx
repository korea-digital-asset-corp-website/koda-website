...
const ContactSection = () => {
  ...
  return (
    <section
      ref={ref}
      className={`mt-10 py-20 lg:pt-[180px] lg:pb-[170px] bg-[var(--color-primary-600)] transition-all duration-800 ease-out ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
      }`}
    >
      <div className="max-w-[1440px] w-full px-10 mx-auto">
        <div className="flex flex-col justify-center items-center space-y-8 lg:space-y-11 mt-32 max-lg:mt-40 lg:mt-0">
          <h2 className="text-headline-lg lg:text-display-md font-bold text-center">
            가장 신뢰할 수 있는 KODA와 함께
            <br />

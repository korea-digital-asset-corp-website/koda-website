...
const V9PrivacyPolicyContent = async () => {
      ...
      <TableContainer>
        ...
        <Tbody>
          ...
          <Tr>
            ...
            <Td>{t('section4.outsourcing.providers.typeForm.purposeV8')}</Td>
          ...
          <Tr>
            <Td className="font-bold">{t('section4.outsourcing.providers.verifyVASP.name')}</Td>
            <Td>{t('section4.outsourcing.providers.verifyVASP.purpose')}</Td>
            <Td>{t('section4.outsourcing.providers.verifyVASP.items')}</Td>
            <Td>{t('section4.outsourcing.providers.verifyVASP.country')}</Td>
            <Td>{t('section4.outsourcing.providers.verifyVASP.period')}</Td>
          </Tr>
        </Tbody>
      </TableContainer>
...
export default V9PrivacyPolicyContent;
